...
Last updated Jul 21, 2026[View as Markdown](https://flueframework.com/docs/ecosystem/deploy/fly/index.md)
...
Flue discovers `db.ts` at build time and wires it into the generated server. The adapter handles schema creation, canonical conversation streams, immutable attachments, and durable submission state. See [Database](https://flueframework.com/docs/guide/database/) for adapter details, [Postgres](https://flueframework.com/docs/ecosystem/databases/postgres/) for the bring-your-own-driver runner, and [Data Persistence API](https://flueframework.com/docs/reference/data-persistence-api/) for the contract.
