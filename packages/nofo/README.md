...
_Effects are automatically cleaned up when the component is unmounted._
...
```html
<nofo-button variant="solid" color="accent" size="2"> Click me </nofo-button>
...
```html
<nofo-ui-button variant="default" size="md"> Submit </nofo-ui-button>

<nofo-ui-card>
  <nofo-ui-card-header>
    <nofo-ui-card-title>Card Title</nofo-ui-card-title>
  </nofo-ui-card-header>
  <nofo-ui-card-content> Card content goes here </nofo-ui-card-content>
</nofo-ui-card>
```
