...
declare function err<TagValue extends string | number | boolean>(
  taggedData: {
    tag: TagValue;
...
declare const matchCode: <T>(
  code: string,
  overrides: Record<string, T>,
  defaultValue?: T,
) => T | undefined;
declare const matchCodeResult: <T>(
  code: string,
...
declare const matchStatus: <T>(
  status: number,
  overrides: Record<number, T>,
  defaultValue?: T,
) => T | undefined;
declare const matchStatusResult: <T>(
  status: number,
...
declare function tagged<TagValue extends string | number | boolean>(
  value: TagValue,
  tagName?: string,
): <T extends Record<string, unknown>>(
  data: T,
...
declare function taggedWith<Tag extends string, TagValue extends string | number | boolean>(
  tag: Tag,
  value: TagValue,
): <T extends Record<string, unknown>>(
  data: T,
...
declare function isTagged<Tag extends string, TagValue extends string | number | boolean>(
  value: unknown,
  tag: Tag,
  tagValue: TagValue,
): value is {
...
export declare function tryWhile<T>(
...
export declare function tryN<T>(
  n: number,
  fn: (attempt: number) => Promise<T>,
  options?: TryNOptions,
): Promise<T>;
export declare function jitterBackoff(
  attempt: number,
  baseDelayMs: number,
  maxDelayMs: number,
): number;
