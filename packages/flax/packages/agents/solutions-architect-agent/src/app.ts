...
import { SolutionsArchitect } from "./agents/solutions-architect";
...
const AGENT_PATH = "/agents/solutions-architect";
...
app.route(AGENT_PATH, createAgentRouter(SolutionsArchitect));
