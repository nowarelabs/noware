...
import { ProductRequirements } from './agents/product-requirements';
...
const AGENT_PATH = '/agents/product-requirements';
...
app.route(AGENT_PATH, createAgentRouter(ProductRequirements));
